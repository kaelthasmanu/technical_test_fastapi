...
class AuthService(BaseService):
    ...
    def sign_in(self, sign_in_info: SignIn):
        ...
        logger.bind(user_id=found_user.id).info("Auth: sign_in success")
        return sign_in_result

    def sign_up(self, user_info: SignUp):
        logger.bind(email=user_info.email).info("Auth: sign_up attempt")
        ...
        logger.bind(user_id=created_user.id).info("Auth: sign_up success")
        return created_user
